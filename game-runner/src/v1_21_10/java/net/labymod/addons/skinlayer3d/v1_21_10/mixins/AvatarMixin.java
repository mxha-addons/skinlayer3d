...
@Mixin(Avatar.class)
public abstract class AvatarMixin extends LivingEntity implements PlayerMeshStorage {

    protected AvatarMixin(EntityType<? extends LivingEntity> entityType, Level world) {
