package cc.mohamed.skinlayer3d.v1_21_4.util;
...
public class SkinHelper {
    ...
    public static boolean setupPlayerMeshes(AbstractClientPlayer abstractClientPlayer, PlayerMeshStorage settings, boolean slimArms) {
        ResourceLocation skinLocation = abstractClientPlayer.getSkin().texture();
